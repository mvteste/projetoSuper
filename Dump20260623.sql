...
-- Dump completed on 2026-06-23 20:21:31
...
--
-- Table structure for table `fornecedor2`
--

DROP TABLE IF EXISTS `fornecedor2`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `fornecedor2` (
  ...
  CONSTRAINT `fornecedor2_ibfk_1` FOREIGN KEY (`codigoCidade`) REFERENCES `cidade` (`codigo`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2026-06-23 20:21:31
CREATE DATABASE  IF NOT EXISTS `senacveiculos` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `senacveiculos`;
-- MySQL dump 10.13  Distrib 8.0.42, for Win64 (x86_64)
--
-- Host: localhost    Database: senacveiculos
-- ------------------------------------------------------
-- Server version	8.0.42
...
CREATE TABLE `carros` (
  ...
  CONSTRAINT `carros_ibfk_1` FOREIGN KEY (`codigoMarca`) REFERENCES `marca` (`codMarca`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Dumping events for database 'senacveiculos'
--

--
-- Dumping routines for database 'senacveiculos'
--
/*!40103 SET TIME_ZONE=@OLD_TIME_ZONE */;
...
-- Dump completed on 2026-06-23 20:21:31
CREATE DATABASE  IF NOT EXISTS `clinicalab` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `clinicalab`;
-- MySQL dump 10.13  Distrib 8.0.42, for Win64 (x86_64)
--
-- Host: localhost    Database: clinicalab
-- ------------------------------------------------------
-- Server version	8.0.42
...
CREATE TABLE `exame` (
  ...
  `laboratorioID` int DEFAULT NULL,
  PRIMARY KEY (`exameID`),
  KEY `pacienteID` (`pacienteID`),
  KEY `laboratorioID` (`laboratorioID`),
  CONSTRAINT `exame_ibfk_1` FOREIGN KEY (`pacienteID`) REFERENCES `paciente` (`pacienteID`) ON DELETE CASCADE,
  CONSTRAINT `exame_ibfk_2` FOREIGN KEY (`laboratorioID`) REFERENCES `laboratorio` (`laboratorioID`) ON DELETE SET NULL
...
CREATE TABLE `laudo` (
  ...
  `descricaoLaudo` varchar(50) DEFAULT NULL,
  `resultado` varchar(15) DEFAULT NULL,
  `observacao` varchar(255) DEFAULT NULL,
  `exameID` int DEFAULT NULL,
  PRIMARY KEY (`laudoID`),
  KEY `exameID` (`exameID`),
  CONSTRAINT `laudo_ibfk_1` FOREIGN KEY (`exameID`) REFERENCES `exame` (`exameID`) ON DELETE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Dumping events for database 'clinicalab'
--

--
-- Dumping routines for database 'clinicalab'
--
/*!40103 SET TIME_ZONE=@OLD_TIME_ZONE */;
...
-- Dump completed on 2026-06-23 20:21:31
CREATE DATABASE  IF NOT EXISTS `atividades` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `atividades`;
-- MySQL dump 10.13  Distrib 8.0.42, for Win64 (x86_64)
--
...
--
-- Dumping events for database 'atividades'
--

--
-- Dumping routines for database 'atividades'
--
/*!40103 SET TIME_ZONE=@OLD_TIME_ZONE */;
...
-- Dump completed on 2026-06-23 20:21:32
CREATE DATABASE  IF NOT EXISTS `sistema_mercado` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `sistema_mercado`;
-- MySQL dump 10.13  Distrib 8.0.42, for Win64 (x86_64)
--
...
CREATE TABLE `contas_pagar` (
  ...
  CONSTRAINT `contas_pagar_ibfk_1` FOREIGN KEY (`caixa_id`) REFERENCES `caixa` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `contas_receber` (
  ...
  PRIMARY KEY (`id`),
  KEY `caixa_id` (`caixa_id`),
  CONSTRAINT `contas_receber_ibfk_1` FOREIGN KEY (`caixa_id`) REFERENCES `caixa` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
DROP TABLE IF EXISTS `contrato_trabalho`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `contrato_trabalho` (
  ...
  CONSTRAINT `contrato_trabalho_ibfk_1` FOREIGN KEY (`funcionario_id`) REFERENCES `funcionario` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `item_pedido` (
  ...
  KEY `pedido_id` (`pedido_id`),
  KEY `produto_id` (`produto_id`),
  CONSTRAINT `item_pedido_ibfk_1` FOREIGN KEY (`pedido_id`) REFERENCES `pedido_compra` (`id`),
...
CREATE TABLE `pedido_compra` (
  ...
  CONSTRAINT `pedido_compra_ibfk_1` FOREIGN KEY (`fornecedor_id`) REFERENCES `fornecedor` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `tabela_preco` (
  ...
  PRIMARY KEY (`id`),
  KEY `produto_id` (`produto_id`),
  CONSTRAINT `tabela_preco_ibfk_1` FOREIGN KEY (`produto_id`) REFERENCES `produto` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Dumping events for database 'sistema_mercado'
--

--
-- Dumping routines for database 'sistema_mercado'
--
/*!40103 SET TIME_ZONE=@OLD_TIME_ZONE */;
...
CREATE TABLE `automovel` (
  ...
  KEY `codigoMarca` (`codigoMarca`),
  CONSTRAINT `automovel_ibfk_1` FOREIGN KEY (`codigoMarca`) REFERENCES `marca` (`codigoMarca`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2026-06-23 20:21:32
CREATE DATABASE  IF NOT EXISTS `mercadosenac` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `mercadosenac`;
-- MySQL dump 10.13  Distrib 8.0.42, for Win64 (x86_64)
--
-- Host: localhost    Database: mercadosenac
-- ------------------------------------------------------
-- Server version	8.0.42
...
CREATE TABLE `estoque` (
  ...
  `QT_Minima` int NOT NULL DEFAULT '0',
  `ID_Local_Estoque` int NOT NULL,
  PRIMARY KEY (`ID_Estoque`),
  KEY `ID_Produto` (`ID_Produto`),
  KEY `ID_Local_Estoque` (`ID_Local_Estoque`),
  CONSTRAINT `estoque_ibfk_1` FOREIGN KEY (`ID_Produto`) REFERENCES `produto` (`ID_Produto`),
  CONSTRAINT `estoque_ibfk_2` FOREIGN KEY (`ID_Local_Estoque`) REFERENCES `local_estoque` (`ID_Local_Estoque`)
...
CREATE TABLE `itens_venda` (
  ...
  KEY `ID_Produto` (`ID_Produto`),
  CONSTRAINT `itens_venda_ibfk_1` FOREIGN KEY (`ID_Venda`) REFERENCES `venda` (`ID_Venda`),
  CONSTRAINT `itens_venda_ibfk_2` FOREIGN KEY (`ID_Produto`) REFERENCES `produto` (`ID_Produto`)
...
CREATE TABLE `local_estoque` (
  `ID_Local_Estoque` int NOT NULL AUTO_INCREMENT,
  `DS_Local` varchar(100) NOT NULL,
  PRIMARY KEY (`ID_Local_Estoque`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `produto` (
  ...
  CONSTRAINT `produto_ibfk_1` FOREIGN KEY (`ID_Categoria`) REFERENCES `categoria_produto` (`ID_Categoria`),
...
CREATE TABLE `venda` (
  ...
  CONSTRAINT `venda_ibfk_3` FOREIGN KEY (`ID_Pagamento`) REFERENCES `pagamento` (`ID_Pagamento`)
) ENGINE=InnoDB AUTO_INCREMENT=228 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping events for database 'mercadosenac'
--

--
-- Dumping routines for database 'mercadosenac'
--
/*!40103 SET TIME_ZONE=@OLD_TIME_ZONE */;
...
-- Dump completed on 2026-06-23 20:21:32
CREATE DATABASE  IF NOT EXISTS `praticando` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `praticando`;
-- MySQL dump 10.13  Distrib 8.0.42, for Win64 (x86_64)
--
...
CREATE TABLE `governador` (
  ...
  KEY `codigo` (`codigo`),
  CONSTRAINT `governador_ibfk_1` FOREIGN KEY (`codigo`) REFERENCES `estado` (`idEstado`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `paciente` (
  ...
  CONSTRAINT `paciente_ibfk_1` FOREIGN KEY (`idPaciente`) REFERENCES `medico` (`idMedico`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping events for database 'praticando'
--

--
-- Dumping routines for database 'praticando'
--
/*!40103 SET TIME_ZONE=@OLD_TIME_ZONE */;
...
-- Dump completed on 2026-06-23 20:21:32
CREATE DATABASE  IF NOT EXISTS `projeto_senac_db` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `projeto_senac_db`;
-- MySQL dump 10.13  Distrib 8.0.42, for Win64 (x86_64)
--
-- Host: localhost    Database: projeto_senac_db
-- ------------------------------------------------------
-- Server version	8.0.42
...
--
-- Dumping events for database 'projeto_senac_db'
--

--
-- Dumping routines for database 'projeto_senac_db'
--
/*!40103 SET TIME_ZONE=@OLD_TIME_ZONE */;
...
-- Dump completed on 2026-06-23 20:21:32
CREATE DATABASE  IF NOT EXISTS `exercicios` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `exercicios`;
-- MySQL dump 10.13  Distrib 8.0.42, for Win64 (x86_64)
--
...
-- Dump completed on 2026-06-23 20:21:33
...
--
-- Table structure for table `pedidos_old`
--

DROP TABLE IF EXISTS `pedidos_old`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `pedidos_old` (
  `id` int NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `produtos_old`
--
