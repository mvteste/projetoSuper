...
import view.TipoFuncionarioView;
import view.ProdutoView;
import view.ClienteListaView;
...
public class TelaInicial extends JFrame {
    ...
    private void inicializarComponentes() {
        ...
        menuCadastro.add(criarItemMenu("Tipo Funcionário", e -> carregarTela(new TipoFuncionarioView())));
        menuCadastro.add(criarItemMenu("Produto", e -> carregarTela(new ProdutoView())));

        
        // No evento do MenuItem do JFrame
this.getContentPane().removeAll();
this.add(new view.ProdutoView()); // ProdutoView é um JPanel, então o add() aceita
this.revalidate();
this.repaint();
        ...
        menuVisualizar.add(criarItemMenu("Cliente", e -> carregarTela(new ClienteListaView())));
